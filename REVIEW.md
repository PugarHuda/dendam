...
5. **Group flair:** https://dendam.vercel.app/group — enter two handles (try `demo-mql7bgwq, judge-7`) → **🔥 Stir it up** / **🏆 Hall of Shame** → then **🆚 Share the head-to-head** for a rivalry card.
